...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash(message="That email doesn't exit, Please try again.", category="error")
...
def show_post(post_id):
    ...
    if requested_comments is None:
        requested_comments = []
    return render_template("post.html", post=requested_post, form=form, comments=requested_comments, gravatar=gravatar)
